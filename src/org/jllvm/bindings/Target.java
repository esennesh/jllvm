...
public class Target {
  ...
  public static long LLVMPointerSizeForAS(SWIGTYPE_p_LLVMOpaqueTargetData arg0, long AS) {
    return TargetJNI.LLVMPointerSizeForAS(SWIGTYPE_p_LLVMOpaqueTargetData.getCPtr(arg0), AS);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueType LLVMIntPtrTypeForAS(SWIGTYPE_p_LLVMOpaqueTargetData arg0, long AS) {
    long cPtr = TargetJNI.LLVMIntPtrTypeForAS(SWIGTYPE_p_LLVMOpaqueTargetData.getCPtr(arg0), AS);
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }
