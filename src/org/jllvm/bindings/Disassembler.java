...
public class Disassembler implements DisassemblerConstants {
  ...
  public static int LLVMSetDisasmOptions(SWIGTYPE_p_void DC, SWIGTYPE_p_uint64_t Options) {
    return DisassemblerJNI.LLVMSetDisasmOptions(SWIGTYPE_p_void.getCPtr(DC), SWIGTYPE_p_uint64_t.getCPtr(Options));
  }
